...
def monopoly_with_fourth_tier
  ...
  # they'll guide you in how to modify what you just did to have more
  # complexity. 
  base_hash={:railroads =>{:pieces =>4,:rent_in_dollars =>{:one_piece_owned =>25,:two_pieces_owned =>50,:three_pieces_owned =>100,:four_pieces_owned => 200},:names =>{:reading_railroad =>{:mortgage_value=>0},:pennsylvania_railroad =>{},:b_and_o_railroad =>{},:shortline_railroad =>{}}} }  
   ...
   base_hash[:railroads][:names][:shortline_railroad]="$800"
    base_hash
end
